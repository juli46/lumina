...
urlpatterns = [
    ...
    # ==================================================
    # DASHBOARD - RECOMENDACIONES / EMPRENDIMIENTO
    # ==================================================
    path('dashboard/recomendaciones/', views.dashboard_recomendaciones, name='dashboard_recomendaciones'),
    path('dashboard/recomendaciones/<int:id>/eliminar/', views.eliminar_recomendacion, name='eliminar_recomendacion'),
    path('api/recomendar-emprendimiento/', views.recomendar_emprendimiento, name='recomendar_emprendimiento'),
